...
class MyWindow(QtWidgets.QMainWindow, Ui_Form):
    def weakly_visualize(self,source,mode='init'):
        ...
        self.actor_gt_weakly = PcdToVtkActor(source,mode='sem')
        self.actor_sup1 = PcdToVtkActor(source,mode='sem')
        self.actor_sup2 = PcdToVtkActor(source,mode='sem')
        #self.actor_origin_weakly.setting_color()
        #self.actor_gt_weakly.setting_color()
        #self.actor_sup1.setting_color()
        #self.actor_sup2.setting_color()
